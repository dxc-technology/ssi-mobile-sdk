...
/**
 * This file is based on corresponding class of Java Wrapper for libindy. If you change indy version ensure to update this class also
...
enum class ErrorCode(private val value: Int) {
     ...
     */
    CommonInvalidParam14(116),  // Wallet errors
     ...
     */
    WalletQueryError(214),  // Ledger errors
     ...
     */
    LedgerNotFound(309),  // Crypto errors
     ...
     */
    AnoncredsCredDefAlreadyExistsError(407),  // Crypto errors
    ...
    companion object {
        private val map: MutableMap<Int, ErrorCode> = mutableMapOf()
